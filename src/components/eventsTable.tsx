...
const EventsTable: React.FC<EventTableProps> = ({ allEvents }) => {
    return (
        ...
        <div className="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
         ...
         <td className="px-6 py-4 whitespace-nowrap">
            <div className="text-sm text-gray-900 capitalize">{removeUnderScore(event.type)}</div>
           <div className="text-sm text-gray-500">Inplay Enabled : {event.inplay_enabled ? 'Yes' : 'No'}</div>
         </td>
         <td className="px-6 py-4 whitespace-nowrap">
